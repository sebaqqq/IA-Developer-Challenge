      ...
      <div className="container mx-auto px-4 py-20 md:py-32 relative z-10">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
            Explorando cómo la inteligencia artificial y la automatización
            pueden revolucionar las tareas y los flujos de trabajo diarios de
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a
              href="#optimization"
              className="inline-flex items-center justify-center px-6 py-3 rounded-lg bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white font-medium transition-colors"
            >
